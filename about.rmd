<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src="C:\Users\Maggie\Desktop\VEDWebsite\VED\Logo.jpg" style=\"float: right;width: 175px;\"/>')
   });
</script>
...
<figure>
<center>
<img src="C:\Users\Maggie\Desktop\VEDWebsite\VED\cameras.jpg" width="500x" alt="picture of cameras used to record data for the VED mounted on a headband">  
</center>
<figcaption>
<div style="text-align: justify">
